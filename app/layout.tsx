...
export const metadata: Metadata = {
  ...
  description: 'تجربه هیجان و مهارت تیم حرفه‌ای اسکیت‌ SFLY نوشهر؛ پیشرو در اجرای حرکات حرفه‌ای، مسابقات اسکیت و توسعه فرهنگ اسکیت‌ در ایران.',
  keywords: 'اسکیت مازندران, آکادمی اسکیت نوشهر, اسکیت‌, تیم اسکیت نوشهر, تیم حرفه‌ای اسکیت, SFLY نوشهر, حرکات اسکیت, مسابقات اسکیت‌, اسکیت ایران',
